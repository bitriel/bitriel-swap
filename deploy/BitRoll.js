...
UNISWAP_ROUTER.set("97", "0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D")
...
module.exports = async function ({ getNamedAccounts, getChainId, deployments }) {
  ...
  const bitrielswapAddress = (await deployments.get("UniswapV2Router02")).address

  await deploy("SelRoll", {
    from: deployer,
    args: [uniswapRouterAddress, bitrielswapAddress],
    log: true,
    deterministicDeployment: false
  })
}

module.exports.tags = ["SelRoll"]
